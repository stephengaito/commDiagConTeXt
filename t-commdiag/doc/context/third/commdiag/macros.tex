...
\startMPdefinitions{commDiag}
  ...
  vardef addArrow
    ...
    text allText =
    %
    save fromTails, aTail, body, toHeads, aHead, outAngle, anArrow, labelPosition;
    ...
    elseif body = "=" :
      draw anArrow shifted (0,  1) bodyText allText ;
      draw anArrow shifted (0, -1) bodyText allText ;
    ...
    if 0 < length(fromTails) :
      for i = 1 upto length(fromTails) :
        ...
        if aTail = 124 : % "|"
          draw barTail anArrow arrowText allText ;
        elseif aTail = 111 : % "o"
    ...
    if 0 < length(toHeads) :
      for i = 1 upto length(toHeads) :
        ...
        if aHead = 124 : % "|" 
          draw barHead anArrow arrowText allText ;
        elseif aHead = 111 : % "o"
